                  ...
                  <div>
                    ...
                    <div className="p-4 sm:p-5 space-y-3">
                      ...
                      <div className="flex items-center justify-between text-xs font-bold gap-2">
                        <span className="text-sky-600 dark:text-sky-400 font-mono uppercase tracking-wider text-xs">{item.category}</span>
                        <span className={`px-2.5 py-0.5 rounded-full text-[11px] font-extrabold ${statusStyle}`}>
                          {statusBadge}
                        </span>
                      </div>

                      <h3 className="text-base sm:text-lg font-extrabold text-slate-900 dark:text-white leading-snug line-clamp-1 group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors">
                        {item.title}
                      </h3>
                    ...
                    <div className="p-4 sm:p-5 pt-0 flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 py-2.5 px-3 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-extrabold text-xs sm:text-sm transition-colors cursor-pointer text-center"
                      >
                        View Details
                      </button>
                      ...
                      {isAlreadyRegistered ? (
                        <button
                          disabled
                          className="flex-1 py-2.5 px-3 rounded-xl bg-emerald-600 text-white font-extrabold text-xs sm:text-sm cursor-not-allowed text-center shadow-xs flex items-center justify-center gap-1"
                        >
                        ...
                        <button
                          disabled
                          className="flex-1 py-2.5 px-3 rounded-xl bg-slate-200 text-slate-500 font-extrabold text-xs sm:text-sm cursor-not-allowed text-center"
                        >
                          Event Full
                        </button>
                      ) : (
                        <button
                          ...
                          className="flex-1 py-2.5 px-3 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-extrabold text-xs sm:text-sm transition-colors cursor-pointer text-center shadow-xs"
                        >
                          Register Now
                        </button>
                      )}
